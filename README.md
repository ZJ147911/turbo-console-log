...
1. 克隆仓库：`git clone git@gitee.com:zj147/turbo-console-log.git`
2. 安装依赖：`pnpm install`
...
- 报告问题：在 Gitee 仓库中创建 issue
- 提交代码：创建分支并提交拉取请求
- 功能建议：在 Gitee 仓库中创建 issue 提出建议
...
- **仓库**：https://gitee.com/zj147/turbo-console-log
