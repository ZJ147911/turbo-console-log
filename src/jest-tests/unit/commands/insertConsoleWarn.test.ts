...
import { insertConsoleWarnCommand } from '@/commands/insertConsoleWarn';
...
describe('insertConsoleWarnCommand', () => {
  ...
  it('should not throw or call debugMessage.msg when no editor is active', async () => {
    ...
    const command = insertConsoleWarnCommand();
  ...
  it('should call debugMessage.msg with correct parameters and warn log type', async () => {
