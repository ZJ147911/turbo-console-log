...
import { insertConsoleErrorCommand } from '@/commands/insertConsoleError';
...
describe('insertConsoleErrorCommand', () => {
  ...
  it('should not throw or call debugMessage.msg when no editor is active', async () => {
    ...
    const command = insertConsoleErrorCommand();
  ...
  it('should call debugMessage.msg with correct parameters and error log type', async () => {
